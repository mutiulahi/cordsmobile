                                    ...
                                    <div class="row">
                                        <div class="content breadcrumbs-wrap">
                                            <div class="heading title">
                                                <h1 class="title">Power Status Real-Time Update</h1>
                                                <p class="font style">Get the current status of the power light update in your environment</p>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="content breadcrumbs-wrap">
                                            <div class="heading title">
                                                <h1 class="title">Direct Complaint</h1>
                                                <p class="font style">Make a complaint directly to the power supplier (feeders) </p>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="content breadcrumbs-wrap">
                                            <div class="heading title">
                                                ...
                                                <p class="font style">Make a suggestions that will be effected on in short time</p>
                                            </div>
